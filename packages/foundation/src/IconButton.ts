...
export {
  frozenIconButtonSizes as IconButtonSize, 
  frozenIconButtonIconSizes as IconButtonIconSize,
  frozenIconButtonStyle as IconButtonStyle,
  frozenIconButtonType as IconButtonType
};

...
>(({ className, ...props }, ref) => (
  <ScrollDownButton
    ref={ref}
    className={cn('dsc-select-scroll-button-container', className)}
    {...props}>
    <svg xmlns="http://www.w3.org/2000/svg" className="dsc-select-scroll-button-icon" viewBox="0 0 256 256">
